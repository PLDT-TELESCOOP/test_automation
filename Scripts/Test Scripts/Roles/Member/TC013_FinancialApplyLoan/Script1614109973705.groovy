...
WebUI.click(findTestObject('Page_TELESCOOP - PLDT Employees Multi-Purpo_3f52d5/radio_FinancialLoan'))

WebUI.click(findTestObject('Page_TELESCOOP - PLDT Employees Multi-Purpo_3f52d5/button_Next'))

WebUI.delay(1)

WebUI.click(findTestObject('Page_TELESCOOP - PLDT Employees Multi-Purpo_3f52d5/FL_SelectLoanItem'))

WebUI.selectOptionByIndex(findTestObject('Page_TELESCOOP - PLDT Employees Multi-Purpo_3f52d5/select_PaymentTermFL'), GlobalVariable.paymentTermIndex)

WebUI.verifyElementPresent(findTestObject('Page_TELESCOOP - PLDT Employees Multi-Purpo_3f52d5/verify_Computation'), 
    0)
