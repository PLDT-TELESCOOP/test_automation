...
WebUI.click(findTestObject('Page_TELESCOOP - PLDT Employees Multi-Purpo_3f52d5/radio_FSDLSR'))

WebUI.click(findTestObject('Page_TELESCOOP - PLDT Employees Multi-Purpo_3f52d5/button_Next'))

WebUI.delay(1)

WebUI.click(findTestObject('Page_TELESCOOP - PLDT Employees Multi-Purpo_3f52d5/FSDLSR_SelectLoanItem'))

WebUI.selectOptionByIndex(findTestObject('Page_TELESCOOP - PLDT Employees Multi-Purpo_3f52d5/select_paymentTermFSDLSR'), 
